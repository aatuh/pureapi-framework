...
func TestStructToAPIFields(t *testing.T) {
	...
	t.Run("NonStructType", func(t *testing.T) {
		expectPanic(t, func() {
			MatchStructAPIFIelds(reflect.TypeOf(123), api.APIFields{}, 0)
		}, "is not a struct")
	})
	...
	t.Run("InterfaceType", func(t *testing.T) {
		...
		expectPanic(t, func() {
			MatchStructAPIFIelds(iface, api.APIFields{}, 0)
	...
	t.Run("AliasNotFound", func(t *testing.T) {
		...
		expectPanic(t, func() {
			MatchStructAPIFIelds(reflect.TypeOf(Dummy{}), api.APIFields{}, 0)
	...
	t.Run("SimpleFieldDefault", func(t *testing.T) {
		...
		out := MatchStructAPIFIelds(reflect.TypeOf(Simple{}), api.APIFields{}, 0)
		if len(out) != 1 {
	...
	t.Run("FieldWithTypeOverride", func(t *testing.T) {
		...
		out := MatchStructAPIFIelds(reflect.TypeOf(CustomType{}), api.APIFields{}, 0)
	...
	t.Run("InvalidRequiredTag", func(t *testing.T) {
		...
		expectPanic(t, func() {
			MatchStructAPIFIelds(reflect.TypeOf(BadRequired{}), api.APIFields{}, 0)
	...
	t.Run("NestedStruct", func(t *testing.T) {
		...
		out := MatchStructAPIFIelds(reflect.TypeOf(Outer{}), api.APIFields{}, 0)
		if len(out) != 1 {
			t.Fatalf("expected 1 field, got %d", len(out))
		}
		nested := out[0].Nested
	...
	t.Run("SliceOfStruct", func(t *testing.T) {
		...
		out := MatchStructAPIFIelds(reflect.TypeOf(Container{}), api.APIFields{}, 0)
		if len(out) != 1 {
			t.Fatalf("expected 1 field, got %d", len(out))
		}
	...
	t.Run("SkipNoJSONTag", func(t *testing.T) {
		...
		out := MatchStructAPIFIelds(reflect.TypeOf(NoJSON{}), api.APIFields{}, 0)
		if len(out) != 1 {
	...
	t.Run("ExtTagMissingField", func(t *testing.T) {
		...
		expectPanic(t, func() {
			MatchStructAPIFIelds(reflect.TypeOf(ExtStruct{}), api.APIFields{}, 0)
	...
	t.Run("PointerField", func(t *testing.T) {
		...
		out := MatchStructAPIFIelds(reflect.TypeOf(PtrStruct{}), api.APIFields{}, 0)
		if len(out) != 1 {
			t.Fatalf("expected 1 field, got %d", len(out))
		}
		expected := "int"
...
func TestStructToAPIFields_Offensive(t *testing.T) {
	...
	t.Run("EmptyJSONTag", func(t *testing.T) {
		...
		out := MatchStructAPIFIelds(reflect.TypeOf(EmptyJSON{}), api.APIFields{}, 0)
		if len(out) != 0 {
	...
	t.Run("DashJSONTag", func(t *testing.T) {
		...
		out := MatchStructAPIFIelds(reflect.TypeOf(DashField{}), api.APIFields{}, 0)
		if len(out) != 1 {
			t.Fatalf("expected 1 field, got %d", len(out))
		}
		if out[0].APIName != "-" {
	...
	t.Run("UnexportedField", func(t *testing.T) {
		...
		out := MatchStructAPIFIelds(reflect.TypeOf(unexported{}), api.APIFields{}, 0)
		if len(out) != 1 {
			t.Fatalf("expected 1 field, got %d", len(out))
		}
		if out[0].APIName != "field" {
	...
	t.Run("SelfReferentialStruct", func(t *testing.T) {
		...
		go func() {
			...
			_ = MatchStructAPIFIelds(reflect.TypeOf(Node{}), api.APIFields{}, 0)
			done <- struct{}{}
		}()
		select {
		case <-done:
	...
	t.Run("DoublePointerField", func(t *testing.T) {
		...
		out := MatchStructAPIFIelds(reflect.TypeOf(DoublePtr{}), api.APIFields{}, 0)
		if len(out) != 1 {
			t.Fatalf("expected 1 field, got %d", len(out))
		}
	...
	t.Run("MalformedValidateTag", func(t *testing.T) {
		...
		out := MatchStructAPIFIelds(reflect.TypeOf(MalformedValidate{}), api.APIFields{}, 0)
		if len(out) != 1 {
			t.Fatalf("expected 1 field, got %d", len(out))
		}
	...
	t.Run("WhitespaceInTags", func(t *testing.T) {
		...
		out := MatchStructAPIFIelds(reflect.TypeOf(WhitespaceTags{}), api.APIFields{}, 0)
		if len(out) != 1 {
			t.Fatalf("expected 1 field, got %d", len(out))
		}
	...
	t.Run("ExtTagFalse", func(t *testing.T) {
		...
		out := MatchStructAPIFIelds(reflect.TypeOf(ExtFalse{}), api.APIFields{}, 0)
		if len(out) != 1 {
			t.Fatalf("expected 1 field, got %d", len(out))
		}
		if out[0].APIName != "field" {
	...
	t.Run("InterfaceField", func(t *testing.T) {
		...
		out := MatchStructAPIFIelds(reflect.TypeOf(InterfaceField{}), api.APIFields{}, 0)
		if len(out) != 1 {
			t.Fatalf("expected 1 field, got %d", len(out))
		}
	...
	t.Run("JSONTagMultipleOptions", func(t *testing.T) {
		...
		out := MatchStructAPIFIelds(reflect.TypeOf(MultiOption{}), api.APIFields{}, 0)
		if len(out) != 1 {
			t.Fatalf("expected 1 field, got %d", len(out))
		}
		if out[0].APIName != "field" {
