...
import (
	...
	"github.com/pureapi/pureapi-util/objectpicker"
	"github.com/pureapi/pureapi-util/urlencoder"
	"github.com/pureapi/pureapi-util/validate"
)
...
func (h *MapInputHandler[Input]) Handle(
	...
	if err := h.validateMap(dataMap, h.apiFields); err != nil {
		return nil, errors.ErrValidation.WithData(ErrValidationData{
			Errors: []FieldError{
				{
					Field:   "input",
					Message: err.Error(),
...
func (h *MapInputHandler[Input]) mapToObject(
	...
	if err := decoder.Decode(value); err != nil {
		return nil, errors.ErrInputDecoding.WithMessage(err.Error())
	}
	return obj, nil
}
