...
type EntityQueryOptions[Entity databasetypes.CRUDEntity] struct {
	tableName      string
	entityFn       func() Entity
	optionEntityFn querytypes.OptionEntityFactoryFn[Entity]
	selectors      Selectors
	updates        Updates
	options        []querytypes.EntityOption[Entity]
}
...
func NewEntityQueryOptions[Entity databasetypes.CRUDEntity](
	tableName string,
	entityFn func() Entity,
	optionEntityFn querytypes.OptionEntityFactoryFn[Entity],
...
func (q *EntityQueryOptions[Entity]) Entity() Entity {
	var entityOpts []querytypes.EntityOption[Entity]
...
func ScanRow[Entity any](t *Entity, row databasetypes.Row) error {
	v := reflect.ValueOf(t).Elem()
	typ := v.Type()
	var pointers []any
